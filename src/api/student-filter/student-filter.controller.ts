...
@ApiBearerAuth()
@Controller('student-filter')
export class StudentFilterController extends BaseController{
    constructor(private readonly studentfilterService:StudentFilterService,
      ){
      super()
    }
  @Get('item/:id')
  async item(@Param('id') id: number) {
    try{
      return this.success(await this.studentfilterService.item(id))
    }catch(e){
      return this.error(e)
    }
  }
  @Post('list')
  async findAll(@Body() dto: SearchStudentFilterDto) {
    try{      
      return this.success(await this.studentfilterService.list(dto))
    }catch(e){
      return this.error(e)
    }
  }
  ...
  async studentDropdown(@Body() dto: SearchStudentDto) {
    try{      
      return this.success(await this.studentfilterService.studentDropdown(dto))
    }catch(e){
      return this.error(e)
    }
  }
  ...
  @Post('create')
  async create(@Body() dto: CreateStudentFilterDto, @Req() req:CustomRequest,){ 
    try{      
      return this.success(await this.studentfilterService.create(dto,req))
    }catch(e){
      return this.error(e)
    }   
  }
  @Put('update/:id')
  async update(@Param('id') id: number,@Body() dto: UpdateStudentFilterDto, @Req() req:CustomRequest,){    
    try{
      return this.success(await this.studentfilterService.update(id,dto,req))
    }catch(e){
      return this.error(e)
    }   
  }
  ...
  async delete(@Param('id') id: number, @Req() req:CustomRequest,){
    try{
      return this.success(await this.studentfilterService.delete(id,req))
    }catch(e){
      return this.error(e)
    }    
  }
